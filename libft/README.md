# Part 1
## [ft_memset](https://www.notion.so/memset-04aa0d186601409da02f728d06589833)
...
## [ft_bzero](https://www.notion.so/bzero-e00d6683b90b4e0fadcee209d133954f)
...
## [ft_memccpy](https://www.notion.so/memccpy-a83f36578390427dbc7a48c646f01a7c)
...
## [ft_memmove](https://www.notion.so/memmove-5494d80048df40f297a3f36e5d25f5e8)
...
## [ft_memchr](https://www.notion.so/memchr-eea913c18a7240589e18e521fb9c79a1)
...
## [ft_memcmp](https://www.notion.so/memcmp-59951c35e0bd4f509f858970af757330)
...
## [ft_strlen](https://www.notion.so/strlen-84f87394c0d149f6b4df8a3c97699001)
...
## [ft_strlcpy](https://www.notion.so/strlcpy-strlcat-d419988e521e49bbb69baeff1a31c70f)
...
## [ft_strlcat](https://www.notion.so/strlcpy-strlcat-d419988e521e49bbb69baeff1a31c70f)
...
## [ft_strchr](https://www.notion.so/strchr-strrchr-1e9948872e074b32b3b93e0496ac4556)
...
## [ft_strrchr](https://www.notion.so/strchr-strrchr-1e9948872e074b32b3b93e0496ac4556)
...
## [ft_strnstr](https://www.notion.so/strnstr-8b7d311e08cc463984e7ec2a39a7e5d6)
...
## [ft_strncmp](https://www.notion.so/strcmp-strncmp-f09d2e275e5c479191766349636cb8c2)
...
## [ft_atoi](https://www.notion.so/atoi-atol-atoll-5d9acdd3858f4ddb9cd0d099c1de7568)
...
## [isalpha, isdigit, isalnum, isascii, isprint](https://www.notion.so/is-series-886a1deb04b84cfca223bf90d22941f9)
...
## [ft_toupper, ft_tolower](https://www.notion.so/toupper-tolower-9ba6db868ef14c1691af83ed13cd5f5b)
### [ft_tosupper 소스 코드](https://github.com/Sondho/42-Seoul/blob/master/libft/src/ft_toupper.c)
### [ft_tolower 소스 코드](https://github.com/Sondho/42-Seoul/blob/master/libft/src/ft_tolower.c)
...
## [ft_calloc](https://www.notion.so/malloc-calloc-valloc-realloc-reallocf-ae32a840c4da452683820f41cc22d3f2)
...
## [ft_strdup](https://www.notion.so/strdup-cacab8c4dcbe43279a3ed6c9fa9cf45e)
...
### 설명
- 문자열 `s`의 각 문자에 `f`함수를 적용하여 `f`의 연속적인 적용으로 인해 발생하는 새 문자열(malloc(3))을 생성

### 반환값
- `f`함수를 통해 변환된 새로운 문자열
- 할당이 실패할 경우 NULL
...
### 설명
- 문자열 `s`를 file descriptor `fd`로 출력
